...
BEGIN
    ...
    WHERE PS.mId = 1 AND PS.forfeit <> curr_id AND PS.mId = JM.mId, J.jId = PS.jId 
...
BEGIN
    ...
    WHERE J1.jId < J2.jId AND P1.jId < P2.jId AND P1.mId = P2.mId AND P1.jId = J1.jId AND P2.jId = J2.jId
END//
DELIMITER;
