    ...
    <div class="flex flex-col gap-4 justify-center items-center min-h-screen">
        <h1 class="font-bold text-4xl flex gap-2 items-center justify-center">Navigation <div class="text-5xl text-red-400 -rotate-20">306</div>
            ...
            <div class="border-2 border-black rounded-xl px-15 py-10 flex  gap-5">
                ...
                <a href="/user/triggers/trigger_1" class="border-2 border-gray-200 rounded-xl p-3 hover:border-indigo-500 flex flex-col items-center">
            ...
            <div class="border-2 border-black rounded-xl px-15 py-10 flex  gap-5">
                ...
                <a href="/user/procedures/procedure_1" class="border-2 border-gray-200 rounded-xl p-3 hover:border-indigo-500 flex flex-col items-center">
